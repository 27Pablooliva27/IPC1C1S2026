 ...
 */
package com.mycompany.Ejemplo_JAVA_Basico;
 ...
 * @author pablo
 */
public class Ejemplo_JAVA_Basico {

    public static void main(String[] args) {
        LocalDateTime fechaHoraActual = LocalDateTime.now();

        // Formato para convertir a String
        DateTimeFormatter formato = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");

        // Asignar a un String
        String fechaHoraStr = fechaHoraActual.format(formato);
        System.out.println(fechaHoraStr);
        // Mostrar
        System.out.println("Fecha y hora en String: " + fechaHoraStr);
        System.out
                .println("------------------------------------------------------------------------------------------");
