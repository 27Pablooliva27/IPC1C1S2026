 ...
 */
package com.mycompany.tableropacman;
...
public class TableroPacman {
    ...
    public static void menu() {
        ...
        System.out.println("Ingresa el tamaño -> P (Pequeño), G (Grande) o 3 para salir");
        ...
        if (opcion.equalsIgnoreCase("P")) {
            ...
            cantidadPremios = 4;
            cantidadTrampas = 2;
            tablero(scanner, random, filas, columnas, cantidadParedes, cantidadPremios, cantidadTrampas);
    ...
    public static void tablero(Scanner scanner, Random random, int filas, int columnas, int cantidadParedes, int cantidadPremios, int cantidadTrampas) {
